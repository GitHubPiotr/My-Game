...
onready var Level = get_tree().get_root().get_child(3)
onready var HContainer = get_node("Panel").get_node("VBoxContainer").get_node("HBoxContainer")
